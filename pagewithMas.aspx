<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="pagewithMas.aspx.vb" Inherits="WebApplication3.page" %>
    ...
    <div class="center-content">
        ...
        <td colspan="2" class="text-center">
            <h3>بيانات الطالب</h3>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="الرقم الجامعي" CssClass="form-label"></asp:Label>
                            </td>
                            <td>
            ...
            <tr>
                <td >
                    ...
                    <asp:Label ID="Label9" runat="server" Text="اسم الطالب" CssClass="form-label"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label15" runat="server" Text="فرع الجامعة" CssClass="form-label"></asp:Label>
                ...
                <td class="text-center" CssClass="form-control">
                    ...
                    <td >
                        <asp:Button ID="Button3" runat="server" Text="بحث عن طالب" CssClass="btn btn-primary rounded-pill" Height="52px" Width="141px" style="background-color: #513D39;" />
                    ...
                    <td >
                        <asp:Button ID="DeleteButton" runat="server" Text="حذف طالب" CssClass="btn btn-primary rounded-pill" Height="52px" Width="138px" style="background-color: #513D39;" />
        ...
        <td colspan="2" class="text-center">
            <asp:Button ID="Button1" runat="server" Text="تحميل البيانات" CssClass="btn btn-primary rounded-pill" Height="52px" Width="102px" style="background-color: #513D39;" />
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                <asp:BoundField DataField="ID_stu" HeaderText="الرقم الجامعي" />
                            </Columns>
